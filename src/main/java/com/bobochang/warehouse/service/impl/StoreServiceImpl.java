...
@CacheConfig(cacheNames = "com.bobochang.warehouse.service.impl.StoreServiceImpl")
@Service
public class StoreServiceImpl implements StoreService {
    ...
    public Result checkStoreNum(String storeNum) {
        //根据仓库编号查询仓库
        com.bobochang.warehouse.entity.Store store = storeMapper.selectStoreByNum(storeNum);
