...
public class CheckinController {
    ...
    @BusLog(descrip = "查询所有签到记录")
    public Result searchAllCheckin(User user) {
        // 查看用户签到的所有日期以及签到总数
        OperPersonHolder.setOperPerson(user.getUserName());
...
//        log.info(String.valueOf(page.getLimitIndex()));
    ...
    @BusLog(descrip = "查询当月缺勤日期")
    public Result checkDate(PageCheckinDto page) {
        OperPersonHolder.setOperPerson(page.getUserName());
