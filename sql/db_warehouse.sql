...
(
    ...
    `contract_type`   char(1)      default null comment '1 待结算 、2 结算中、 3 已结算',
  ...
  AUTO_INCREMENT = 98
  DEFAULT CHARSET = utf8mb3 COMMENT ='合同表';
...
(
  ...
  AUTO_INCREMENT = 98
  DEFAULT CHARSET = utf8mb3 COMMENT ='权限表';

/*Data for the table `auth_info` */

insert into `auth_info`(`auth_id`, `parent_id`, `auth_name`, `auth_desc`, `auth_grade`, `auth_type`, `auth_url`,
                        `auth_code`, `auth_order`, `auth_state`, `create_by`, `create_time`, `update_by`, `update_time`)
values (1, 0, '用户管理', '用户管理', 1, '1', NULL, NULL, 0, '1', 1, '2017-11-14 16:54:13', 1, '2017-11-14 16:54:17'),
       ...
       (42, 0, '商品管理', '商品管理', 1, '1', '', '', 1, '1', 1, '2017-11-29 11:56:44', NULL, NULL),
       ...
       (50, 42, '商品列表', '商品列表', 2, '2', '/commodity/index', '', 1, '1', 1, '2017-12-07 08:47:50', NULL, NULL),
       ...
       (74, 72, '供货商列表', '供货商列表', 2, '2', '', '', 1, '1', 1, '2017-12-13 17:10:14', NULL, NULL),
       (76, 42, '商品分类', '商品分类', 2, '2', '/commodity/category', '', 1, '1', 1, '2017-12-14 11:16:38', NULL,
        NULL),
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb3 COMMENT ='品牌';

/*Data for the table `brand` */

insert into `brand`(`brand_id`, `brand_name`, `brand_leter`, `brand_desc`)
...
(
  ...
  AUTO_INCREMENT = 48
  DEFAULT CHARSET = utf8mb3 COMMENT ='采购单';

/*Data for the table `buy_list` */

insert into `buy_list`(`buy_id`, `product_id`, `store_id`, `buy_num`, `fact_buy_num`, `buy_time`, `supply_id`,
                       `place_id`, `buy_user`, `phone`, `is_in`)
values (1, 1, 1, 200, 198, '2017-12-19 09:45:49', 1, 2, 'rose', '13474421775', '1'),
       ...
       (14, 5, 1, 666, 0, '2021-12-11 17:27:13', 2, 3, 'kobe', '35436375757', '0'),
       ...
       (40, 21, 1, 100, NULL, '2022-04-19 18:39:30', 2, 4, 'justin', '19875673733', '0'),
...
(
  ...
  AUTO_INCREMENT = 47
  DEFAULT CHARSET = utf8mb3 COMMENT ='入库单';

/*Data for the table `in_store` */

insert into `in_store`(`ins_id`, `store_id`, `product_id`, `in_num`, `create_by`, `create_time`, `is_in`)
values (1, 1, 1, 150, 1, '2017-12-08 14:17:02', '1'),
       ...
       (40, 1, 5, 600, 1, '2022-04-21 09:35:35', '0'),
       ...
       (45, 1, 25, 80, 28, '2022-04-24 15:50:54', '0'),
...
(
  ...
  AUTO_INCREMENT = 14
  DEFAULT CHARSET = utf8mb3 COMMENT ='出库单';

/*Data for the table `out_store` */

insert into `out_store`(`outs_id`, `product_id`, `store_id`, `tally_id`, `out_price`, `out_num`, `create_by`,
                        `create_time`, `is_out`)
...
(
  ...
  AUTO_INCREMENT = 7
  DEFAULT CHARSET = utf8mb3 COMMENT ='产地';

/*Data for the table `place` */

insert into `place`(`place_id`, `place_name`, `place_num`, `introduce`, `is_delete`)
...
(
  ...
  AUTO_INCREMENT = 31
  DEFAULT CHARSET = utf8mb3 COMMENT ='商品表';

/*Data for the table `product` */

insert into `product`(`product_id`, `store_id`, `brand_id`, `product_name`, `product_num`, `product_invent`, `type_id`,
                      `supply_id`, `place_id`, `unit_id`, `introduce`, `up_down_state`, `in_price`, `sale_price`,
                      `mem_price`, `create_time`, `update_time`, `create_by`, `update_by`, `imgs`, `product_date`,
                      `supp_date`)
values (1, 1, 3, '海尔电视d1-1111', 'haier1001', 319, 3, 4, 5, 6, '43242342342343', '1', '3899.00', '4999.00',
        '4599.00', '2017-12-06 12:09:12', '2022-04-08 15:24:14', 1, 1, '/img/upload/haier_tv.jpg',
        '2016-02-22 08:00:00', '2028-10-11 08:00:00'),
       (5, 2, 3, '海尔洗衣机h1-1131', 'haierh11132', 157, 2, 2, 3, 6, 'weqweqweqwe', '1', '3899.00', '4999.00',
        '4599.00', '2017-12-06 12:09:12', '2017-12-08 17:14:12', 1, 1, '', '2016-02-23 00:00:00',
        '2027-02-23 00:00:00'),
       ...
       (11, 1, 3, '海尔洗衣机h1-1136', 'haier1003', 111, 2, 4, 3, 6, '洗的很干净', '1', '3899.00', '4999.00', '4599.00',
        ...
        '2027-02-22 08:00:00'),
       (12, 1, 3, '海尔洗衣机h1-1137', 'haierh11138', 222, 2, 2, 3, 6, 'weqweqweqwe', '1', '3899.00', '4999.00',
        '4599.00', '2017-12-06 12:09:12', '2022-04-08 15:44:51', 1, 1, '/img/upload/h1130.png', '2016-02-22 08:00:00',
        '2017-02-22 08:00:00'),
       ...
       (14, 2, 3, '海尔洗衣机h1-1138', 'haierh11132a', 43, 2, 2, 2, 6, '海尔洗衣机好啊', '0', '3899.00', '4999.00',
        '4599.00', '2017-12-06 12:09:12', '2017-12-14 09:42:24', 1, 1, '', '2017-12-31 00:00:00',
        '2029-09-23 00:00:00'),
       (19, 2, 1, '西瓜2号', 'xg9527', 2000, 6, 2, 3, 2, '皮薄保甜', '0', '3.00', '5.00', '4.00', '2022-04-08 11:19:38',
        NULL, 1, NULL, '/img/upload/watermelon.png', '2022-04-09 08:00:00', '2022-04-30 08:00:00'),
       ...
       (22, 1, 2, '空调', 'midea1001', 170, 7, 5, 6, 6, '很凉快', '0', '2000.00', '3999.00', '3699.00',
        '2022-04-08 15:39:56', NULL, 1, NULL, '/img/upload/midea_ac.png', '2022-03-24 08:00:00', '2034-12-20 08:00:00'),
       ...
       (24, 2, 1, '香蕉', 'xg124', NULL, 6, 2, 4, 3, '香蕉啊', '0', '2.50', '5.50', '3.50', '2022-04-08 11:58:47',
        '2022-04-08 15:11:48', 1, 1, '/img/upload/banana.png', '2017-12-19 08:00:00', '2017-12-29 08:00:00'),
       (25, 1, 2, '风扇', 'midea1004', 7, 8, 5, 6, 6, '没有风，只有声。。。', '1', '100.00', '299.00', '249.00',
       ...
       (28, 3, 1, '西瓜', 'xigua6', 220, 6, 1, 2, 2, '不好吃，别买了', '0', '2.50', '20.50', '8.50',
        '2017-12-14 10:39:14', '2022-04-24 16:02:49', 1, 1, '/img/upload/xigua2.jpeg', '2017-12-09 08:00:00',
        '2027-12-18 08:00:00'),
       (29, 3, 4, '华为手机', 'huawei_mate40_1', 30, 12, 5, 3, 6, '高端大气上档次', '0', '2000.00', '5999.00',
        '5699.00', '2022-04-24 15:43:05', '2022-04-24 15:57:44', 31, 1, '/img/upload/mate40.jpg', '2022-03-17 08:00:00',
        '2042-07-24 08:00:00'),
...
(
  ...
  AUTO_INCREMENT = 14
  DEFAULT CHARSET = utf8mb3 COMMENT ='商品分类表';
...
values (1, '超级管理员', '超级管理员', 'supper_manage', '1', 1, '2017-11-14 16:49:12', 1, '2017-11-14 16:49:20'),
       (2, '管理员', '管理员', 'manage', '0', 1, '2018-11-14 16:49:12', 1, NULL),
       (3, '普通用户', '普通用户', 'comm_manage', '0', 1, '2019-11-14 16:49:12', 1, '2022-03-25 15:09:41'),
       (11, '采购', '采购管理员', 'purchase_man', '1', 1, '2022-04-22 12:29:00', 1, '2022-04-22 13:56:29'),
       (12, '入库', '入库管理员', 'in_store', '1', 1, '2022-04-22 13:56:17', NULL, NULL),
       (13, '商品', '商品管理员', 'commodity_manager', '1', 1, '2022-04-22 13:57:42', NULL, NULL),
       (14, '出库', '出库管理员', 'out_store', '1', 1, '2022-04-22 14:00:00', NULL, NULL),
...
(
  ...
  AUTO_INCREMENT = 746
  DEFAULT CHARSET = utf8mb3 COMMENT ='角色权限表';
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb3 COMMENT ='仓库表';
...
(
  ...
  AUTO_INCREMENT = 6
  DEFAULT CHARSET = utf8mb3 COMMENT ='供货商';

/*Data for the table `supply` */

insert into `supply`(`supply_id`, `supply_num`, `supply_name`, `supply_introduce`, `concat`, `phone`, `address`,
                     `is_delete`)
...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8mb3 COMMENT ='规格单位表';

/*Data for the table `unit` */

insert into `unit`(`unit_id`, `unit_name`, `unit_desc`)
values (1, '箱/件', '箱/件'),
       (2, '个', '个'),
       (3, '公斤', '公斤'),
       (4, '只', '只'),
...
insert into `user_info`(`user_id`, `user_code`, `user_name`, `user_pwd`, `user_type`, `user_state`, `is_delete`,
